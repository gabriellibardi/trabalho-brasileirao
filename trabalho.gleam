...
/// Retorna a *lista_desempenhos* ordenada com base nos desempenhos dos times, onde vitórias
/// valem 3 pontos e empates valem 1 ponto. Caso dois times empatem, o desempate é feito de
/// forma hierárquica pelo número de vitórias, saldo de gols (número de gols feitos menos o
/// número de gols sofridos) e pela ordem alfabética.
